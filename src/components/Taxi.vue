<template>
   <div id="taxi" class="d-flex flex-column ">
    <div class="d-flex justify-content-around flex-wrap">
      <base-input type="text" placeholder="Hardan" large ></base-input>
      ...
      <base-button class="base" name="Hesabla"></base-button>
    </div>
